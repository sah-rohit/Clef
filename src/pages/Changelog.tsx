...
const releases: Release[] = [
  {
    ...
    summary: "Major UI overhaul with vibrant color system, responsive mobile fixes, and custom cursor redesign.",
    changes: [
      { type: "new",      text: "Vibrant color palette: cyan (#00E5FF), green (#00FF87), purple (#7C3AED) added site-wide" },
      { type: "new",      text: "How To Use page with step-by-step guide, FAQ, and keyboard shortcuts" },
      { type: "new",      text: "Changelog page (you're reading it)" },
      { type: "improved", text: "Tool cards now use each tool's accent color as a subtle background tint" },
      { type: "improved", text: "Custom cursor redesigned — crosshair reticle with mix-blend-mode for universal visibility" },
      { type: "improved", text: "Custom cursor no longer breaks after returning from DevTools" },
      { type: "improved", text: "Filter tabs on mobile now scroll horizontally instead of wrapping into a 2×2 grid" },
      { type: "improved", text: "Tool card aspect ratio on mobile changed from portrait to landscape for better fit" },
      ...
      { type: "fixed",    text: "Dark gradient overlay on mobile tool cards was too heavy — lightened significantly" },
      { type: "fixed",    text: "README privacy section clarified: guest mode is local-only, signed-in mode uses Convex" },
    ],
  },
  {
    version: "v1.3.0",
  ...
  },
  {
    ...
    summary: "Initial public launch of Clef Workbench with 12 core tools.",
    changes: [
